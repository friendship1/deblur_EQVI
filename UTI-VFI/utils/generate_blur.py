...
parser.add_argument('--videos_src_path', type=str, default='/data0/jwwoo/gopro/test', help='the dir of high-frame-rate video')
parser.add_argument('--videos_save_path', type=str, default='/data0/jwwoo/gopro/LFR_Gopro_17', help='the dir of low-frame-rate video')
parser.add_argument('--num_compose', type=int, default=1, help='how many frames to compose a blurry frame')
parser.add_argument('--tot_inter_frame', type=int, default=8, help='the down sample rate')
