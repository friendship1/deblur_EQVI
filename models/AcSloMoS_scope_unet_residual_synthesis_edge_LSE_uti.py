...
class AcSloMoS_scope_unet_residual_synthesis_edge_LSE(nn.Module):
    ...
    def forward(self, I0_blur, I1_blur, I2_blur, I3_blur, t):

        # Input: I0-I3: (N, C, H, W)
        #          t: (N, 1, 1, 1) or constant*
        if I0_blur is not None and I3_blur is not None:
            out1, out2 = self.SE_deblur_net(I0_blur, I1_blur, I2_blur, I3_blur)
            choose_out = out2
            # clean_output = {'B1_S':choose_out[0],'B1_E':choose_out[1],'B2_S':choose_out[2],'B2_E':choose_out[3]}
            I0, I1, I2, I3 = choose_out
        ...
        return It_warp, I1t, I2t, It_warp, It_warp, F12, F21, I1tf, I2tf, M, output[:, :2], output[:, 2:4], Ft1, Ft2, Ft1r, Ft2r, F1t, F2t, norm1, norm2, choose_out
